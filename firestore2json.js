...
const serviceAccount = require("./_credentials/firebase.json");

admin.initializeApp({ credential: admin.credential.cert(serviceAccount) });

const schema = require('./_config/schema').schema;
...
firestore2json(admin.firestore(), { ...schema }, {}).then(res =>
  fs.writeFileSync('./_data/events.export.json', JSON.stringify(res, null, 2), 'utf8')
);